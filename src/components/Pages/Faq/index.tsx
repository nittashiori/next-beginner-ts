      ...
      >
        <Tabs>
          <TabList className={styles.tabList}>
            <Tab className={styles.tab}>会社について</Tab>
            <Tab className={styles.tab}>製品について</Tab>
            <Tab className={styles.tab}>その他</Tab>
          </TabList>
            ...
            <TabPanel>
              <Accordion allowMultiple>
                <AccordionItem className={styles.accordionItem}>
                  ...
                  <AccordionPanel className={styles.accordionPanel}>
                    当社は製品やサービスの品質に非常に厳格な基準を設けています。品質管理チームが製造プロセス全体を監視し、最新の技術とテスト方法を使用して製品の耐久性と信頼性を確保しています。お客様の満足度を最優先に考え、常に品質向上に取り組んでいます。      </AccordionPanel>
                </AccordionItem>
              </Accordion>
            </TabPanel>
            <TabPanel>
              <Accordion allowMultiple>
                <AccordionItem className={styles.accordionItem}>
                  <h2>
                    <AccordionButton className={styles.accordionButton}>
                      <Box as="span" flex='1' textAlign='left'>
                        業績に関する問い合わせはどうすればよいですか？
                      </Box>
                      <AccordionIcon />
                    </AccordionButton>
                  </h2>
                  <AccordionPanel className={styles.accordionPanel}>
                    業績に関するお問い合わせは<CustomLink href="#">こちら</CustomLink>をご覧下さい。
                  </AccordionPanel>
                </AccordionItem>
              </Accordion>
            </TabPanel>
